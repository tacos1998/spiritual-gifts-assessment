  ...
  const [giftScores, setGiftScores] = useState([
    ...
    },
    {
      ...
      local: [
        ...
        {
          name: "Shelter House",
          description: "Shelter House provides shelter, intervention and primary prevention programs to the community through education, awareness and advocating for social change. Volunteers that wish to work closely with participants or work on the 24-hour hotline are required to attend a 30-hour Core Competency Training. This is a 24-hour class (three full days) in addition to six hours of observation. Volunteers who wish to get more deeply involved must complete Advocacy Core Training, which includes self-led online training, role playing and on-the-job training. For those not interested in direct service, opportunities include sorting through donations, collecting cell phones in the community, promoting and working events and fundraisers, handing out brochures and flyers, picking up donations, assisting with administrative duties, and much more. Opportunities for groups are also available. Your business, religious organization, youth group or other organization can work together for a group project.",
